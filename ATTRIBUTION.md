...
them on first use. That is deliberate: the licences permit use, but the
...
Under CCAL 2.0 (Creative Commons Attribution Licence 2.0). Parts are
...
the generated catalogue, for instance — that file falls under the same licence.
