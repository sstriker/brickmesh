...
var partColour = map[string]int{
	...
	// Not from a set: 4158 is a 2023 part and none of these eight has one. The
	// builder knows it, which is a better source than a stand-in and is marked
	// as its own kind of evidence rather than passed off as a sighting.
	"4158.dat":     322, // medium azure, from the builder
